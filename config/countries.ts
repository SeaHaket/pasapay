export type OfframpProvider = "minipay" | "localcrypto" | "transak" | "fonbnk" | "solana";
...
export const COUNTRIES: CountryConfig[] = [
  // ─── Southeast Asia ────────────────────────────────────────────────────────
  {
    ...
    currencySymbol: "₱",
    phonePrefix: "+63",
    supportedOfframps: ["minipay", "fonbnk", "transak", "localcrypto", "solana"],
  ...
  },
  {
    ...
    currencySymbol: "Rp",
    phonePrefix: "+62",
    supportedOfframps: ["minipay", "transak", "localcrypto", "solana"],
  ...
  // ─── Africa (Fonbnk-supported) ─────────────────────────────────────────────
  {
    ...
    currencySymbol: "₦",
    phonePrefix: "+234",
    supportedOfframps: ["minipay", "localcrypto", "fonbnk", "solana"],
