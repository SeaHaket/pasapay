...
export const COUNTRIES: CountryConfig[] = [
  ...
  },
  {
    ...
    phonePrefix: "+65",
    supportedOfframps: ["minipay", "localcrypto", "transak"],
    localCryptoName: "Coinhako / Binance etc.",
    bankOfframpExample: "GrabPay, PayNow, or bank",
  ...
  },
  {
    ...
    phonePrefix: "+82",
    supportedOfframps: ["minipay", "localcrypto", "transak"],
    localCryptoName: "Upbit / Bithumb etc.",
    bankOfframpExample: "KakaoPay, Toss, or bank",
  ...
  },
  {
    ...
    phonePrefix: "+81",
    supportedOfframps: ["minipay", "localcrypto", "transak"],
    localCryptoName: "bitFlyer / Coincheck etc.",
    bankOfframpExample: "PayPay, LinePay, or bank",
